namespace SafeEats.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        RecipeDirections = c.String(),
                        RecipeCreator_Id = c.String(maxLength: 128),
                    })
                .PrimaryKey(t => t.RecipeId)
                .ForeignKey("dbo.AspNetUsers", t => t.RecipeCreator_Id)
                .Index(t => t.RecipeCreator_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Recipes", "RecipeCreator_Id", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.Recipes", new[] { "RecipeCreator_Id" });
